 ...
 */
final class Version20221103191127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE painting (id INT AUTO_INCREMENT NOT NULL, technic_id INT NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, author VARCHAR(255) NOT NULL, height INT NOT NULL, width INT NOT NULL, image_name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, date VARCHAR(255) NOT NULL, rarity_score INT NOT NULL, visible TINYINT(1) NOT NULL, INDEX IDX_66B9EBA0FAAE137C (technic_id), INDEX IDX_66B9EBA012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
